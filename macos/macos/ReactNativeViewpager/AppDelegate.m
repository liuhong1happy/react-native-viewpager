...
-(id)init
{
    if(self = [super init]) {
        ...
        [windowController setWindowFrameAutosaveName:@"ReactNativeViewpager"];
...
- (void)applicationDidFinishLaunching:(__unused NSNotification *)aNotification
{
    ...
    RCTRootView *rootView = [[RCTRootView alloc] initWithBridge:_bridge
                                                     moduleName:@"ReactNativeViewpager"
...
- (void)setUpApplicationMenu
{
    ...
    [rootMenu addItemWithTitle:@"Quit ReactNativeViewpager" action:@selector(terminate:) keyEquivalent:@"q"];
